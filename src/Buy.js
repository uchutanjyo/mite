...
<Paragraph>
Also, as was Also promised on that page, Mite will give you a CD-R for 1 cent (any album). Canadian Penny , please.</Paragraph>
<Paragraph>
stay tuned for more merchandise.</Paragraph>
  </Main>
  );
};
